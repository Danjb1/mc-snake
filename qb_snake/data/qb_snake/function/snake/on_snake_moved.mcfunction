...
execute as @e[type=minecraft:block_display,tag=tailAnim] if score @s team = @e[type=minecraft:marker,tag=currentSnake,limit=1] team run tp @s @e[type=minecraft:marker,tag=lastTail,limit=1]
